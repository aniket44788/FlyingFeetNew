...
const trek = {
  ...
  relatedTreks: [
    ...
    { name: "Chopta Tungnath Trek", slug: "/treks/chopta-tungnath-trek", price: 4999, rating: 4.8, reviews: 130, badge: "Serene", duration: "4D/3N", location: "Uttarakhand" },
  ],
};
      ...
      <div className="relative h-64 sm:h-80 md:h-[480px] lg:h-[540px] overflow-hidden">
        ...
        <div className="absolute top-4 left-4 md:left-10 z-20">
          <div className="flex items-center gap-1.5 text-white/60 text-xs font-medium">
            ...
            <span>Trekking</span>
            <span>/</span>
            <span className="text-white font-semibold">Kedarkantha Trek</span>
          </div>
        </div>
