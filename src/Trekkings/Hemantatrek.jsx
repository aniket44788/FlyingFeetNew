...
const trek = {
  ...
  reviews: 210,
  overview:
    "Hampta Pass Trek is the adventurous crossover trek from the lush green valleys of Kullu to the arid landscapes of Spiti. This varied landscape including green meadows, snow-covered passes, and rugged terrains, is perfect for both beginners and experienced trekkers.",
  highlights: [
    ...
    <div className="min-h-screen font-sans" style={{ backgroundColor: T.darkBg }}>
      ...
      <div className="relative h-[520px] md:h-[620px] overflow-hidden">
        ...
        <div className="absolute top-6 left-6 md:left-12 z-10">
          <div className="flex items-center gap-2 text-white/70 text-xs tracking-widest uppercase">
            ...
            <span className="text-white">Hampta Pass Trek</span>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 py-12 grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          {/* Itinerary - Updated with your new data */}
          {activeTab === "itinerary" && (
            <div className="rounded-3xl p-8" style={{ backgroundColor: T.cardBg, border: `1px solid ${T.cardBorder}` }}>
            ...
            <div className="p-6 space-y-5">
              <div>
                ...
                >
                  ...
                  <option value="2025-07-05">05 Jul 2025</option>
                  <option value="2025-08-10">10 Aug 2025</option>
                </select>
              </div>
