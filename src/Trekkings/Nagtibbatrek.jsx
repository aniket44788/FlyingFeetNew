...
const trek = {
  ...
  altitude: "9,910 ft",           // Standard altitude for Nag Tibba Summit
  season: "Oct - Jun",
  startPoint: "Pantwari",
  price: 6499,
  rating: 4.7,
      ...
      <div className="relative h-[520px] md:h-[620px] overflow-hidden">
        ...
        <div className="absolute top-6 left-6 md:left-12 z-10">
          <div className="flex items-center gap-2 text-white/70 text-xs tracking-widest uppercase">
            ...
            <span className="text-white">Nag Tibba Trek</span>
          </div>
        </div>
            ...
            <div className="p-6 space-y-5">
              <div>
                ...
                >
                  ...
                  <option value="2025-04-20">20 Apr 2025</option>
