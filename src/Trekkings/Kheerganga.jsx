...
const trek = {
  ...
  reviews: 195,
  overview:
    "Kheerganga Trek is a popular trek in Himachal Pradesh that takes you through dense pine forests, beautiful meadows, and natural hot springs. It's perfect for beginner trekkers looking for both adventure and relaxation. The trail follows the Parvati River valley and rewards you with one of the most serene camping spots in the Himalayas.",
  highlights: [
  ...
  itinerary: [
    {
      ...
      activities: [
        "Start trek from Barshaini",
        "Trek through dense pine forests",
        "Reach Kheerganga campsite",
        "Enjoy a dip in natural hot springs",
        "Overnight camping",
      ],
    },
    {
      day: 2,
      title: "Kheerganga Exploration",
      activities: [
        "Explore the meadows and surroundings",
        "Visit the Shiva temple at Kheerganga",
        "Relax at the natural hot spring pools",
    ...
    },
    {
      ...
      activities: [
        "Relaxing morning at Kheerganga",
        "Descend back to Barshaini",
        "Return drive to Bhuntar / Manali / Delhi",
        "Trip ends",
      ],
    },
  ],
      ...
      <div className="relative h-64 sm:h-80 md:h-[480px] lg:h-[560px] overflow-hidden">
        ...
        <div className="absolute top-4 left-4 md:left-10 z-20">
          <div className="flex items-center gap-1.5 text-white/70 text-xs font-medium">
            ...
            <span>Trekking</span>
            <span>/</span>
            <span className="text-white font-semibold">Kheerganga Trek</span>
          </div>
        </div>
