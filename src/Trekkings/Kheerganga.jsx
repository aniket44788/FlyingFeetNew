...
const trek = {
  ...
  reviews: 195,
  overview:
    "Kheerganga Trek is a popular trek in Himachal Pradesh that takes you through dense pine forests, beautiful meadows, and natural hot springs. It's perfect for beginner trekkers looking for both adventure and relaxation.",
  highlights: [
      ...
      <div className="relative h-[520px] md:h-[620px] overflow-hidden">
        ...
        <div className="absolute top-6 left-6 md:left-12 z-10">
          <div className="flex items-center gap-2 text-white/70 text-xs tracking-widest uppercase">
            ...
            <span className="text-white">Kheerganga Trek</span>
          </div>
        </div>
