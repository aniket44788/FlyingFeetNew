...
const trek = {
  ...
  reviews: 175,
  overview:
    "Sar Pass Trek is a gorgeous trek in Himachal Pradesh that takes you through dense forests, beautiful snow-capped mountains, and high-altitude meadows. It is perfect for beginners looking for a mix of adventure, snow, and scenic beauty.",
  highlights: [
    "Stunning snow-capped mountains",
    "Dense forest trails",
    "Serene high-altitude meadows",
    "Overnight camping at scenic locations",
  ],
  ...
  itinerary: [
    {
      ...
      activities: [
        "Start trek from Kasol",
        "Trek through dense forest",
        "Camp overnight at Grahan",
      ],
    },
    {
      day: 2,
      ...
      activities: [
        "Trek through pine & rhododendron forests",
        "Reach the campsite at Min Thach",
        "Overnight camping",
      ],
    },
    {
      ...
      activities: [
        "Steep ascent begins",
        "Enter snow-covered region",
        "Open mountain views from dense forests",
        "Reach Nagaru campsite",
        "Enjoy beautiful sunset view",
        "Overnight camping",
      ],
    },
    {
      ...
      activities: [
        ...
        "Experience famous snow slides",
        "Descend to Biskeri Thach",
        "Overnight camping",
      ],
    },
    {
      ...
      activities: [
        "Descend through lush meadows",
        "Pass through forests",
        "Reach Barshaini",
        "Relax after long descent",
        "Overnight stay",
      ],
    },
    {
      day: 6,
      title: "Barshaini to Kasol",
      activities: [
        "Morning drive back to Kasol",
      ...
      <div className="relative h-[520px] md:h-[620px] overflow-hidden">
        ...
        <div className="absolute top-6 left-6 md:left-12 z-10">
          <div className="flex items-center gap-2 text-white/70 text-xs tracking-widest uppercase">
            ...
            <span className="text-white">Sar Pass Trek</span>
          </div>
        </div>
            ...
            <div className="p-6 space-y-5">
              <div>
                ...
                >
                  ...
                  <option value="2025-03-20">20 Mar 2025</option>
                  <option value="2025-05-15">15 May 2025</option>
